...
--	MAME_DIR .. "src/devices/machine/buffer.h",
	...
	MAME_DIR .. "src/devices/machine/keyboard.cpp", -- CPS
	MAME_DIR .. "src/devices/machine/keyboard.h", -- CPS
	MAME_DIR .. "src/devices/machine/keyboard.ipp", -- CPS
	MAME_DIR .. "src/devices/machine/laserdsc.cpp", -- CPS
	MAME_DIR .. "src/devices/machine/laserdsc.h", -- CPS
	...
	MAME_DIR .. "src/devices/machine/legscsi.cpp", -- CPS
	MAME_DIR .. "src/devices/machine/legscsi.h", -- CPS
--	MAME_DIR .. "src/devices/machine/sdlc.cpp",
--	MAME_DIR .. "src/devices/machine/sdlc.h",
	MAME_DIR .. "src/devices/machine/terminal.cpp", -- CPS
	MAME_DIR .. "src/devices/machine/terminal.h", -- CPS
...
--	MAME_DIR .. "src/devices/imagedev/bitbngr.h",
	...
	MAME_DIR .. "src/devices/imagedev/chd_cd.cpp", -- CPS
	MAME_DIR .. "src/devices/imagedev/chd_cd.h", -- CPS
--	MAME_DIR .. "src/devices/imagedev/diablo.cpp",
--	MAME_DIR .. "src/devices/imagedev/diablo.h",
	MAME_DIR .. "src/devices/imagedev/flopdrv.cpp", -- CPS
	MAME_DIR .. "src/devices/imagedev/flopdrv.h", -- CPS
	MAME_DIR .. "src/devices/imagedev/floppy.cpp",
	MAME_DIR .. "src/devices/imagedev/floppy.h",
	MAME_DIR .. "src/devices/imagedev/harddriv.cpp", -- CPS
	MAME_DIR .. "src/devices/imagedev/harddriv.h", -- CPS
