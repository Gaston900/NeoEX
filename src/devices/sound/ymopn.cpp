...
ym2610_device_base<ChipClass>::ym2610_device_base(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock, device_type type) :
	...
	m_adpcm_a_config("adpcm-a", ENDIANNESS_LITTLE, 8, 25, 0), // Modified Code Source (HBMAME)
	m_adpcm_b_config("adpcm-b", ENDIANNESS_LITTLE, 8, 25, 0), // Modified Code Source (HBMAME)
