...
class neogeo_ek_gsc_cart_device : public neogeo_rom_device
{
public:
	neogeo_ek_gsc_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock);
	virtual int get_fixed_bank_type() override { return 0; }
...
DECLARE_DEVICE_TYPE(NEOGEO_EK_GSC_CART, neogeo_ek_gsc_cart_device)
