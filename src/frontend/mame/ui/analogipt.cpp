...
//===========================================================================================================>>>
		...
		std::string temp_bar_name = data.field.get().name();
		char commandbuf[1024];
		std::snprintf(commandbuf, sizeof(commandbuf), "%s", temp_bar_name.c_str());
		convert_command_glyphs(commandbuf, sizeof(commandbuf));
...
//===========================================================================================================>>>
		char commandbuf[1024];
		std::snprintf(commandbuf, sizeof(commandbuf), "%s", text.c_str());
		convert_command_glyphs(commandbuf, sizeof(commandbuf));
		text = commandbuf;
//===========================================================================================================>>>
