...
const options_entry ui_options::s_option_entries[] =
{
	...
	{ OPTION_FORCED4X3,                     "0",        OPTION_BOOLEAN,     "force the appearance of the snapshot in the list software to 4:3" }, // 修改的 (加斯顿90)
	{ OPTION_USE_BACKGROUND,                "1",        OPTION_BOOLEAN,     "enable background image in main view" },
	{ OPTION_SKIP_BIOS_MENU,                "1",        OPTION_BOOLEAN,     "skip bios submenu, start with configured or default" }, // 修改的 (加斯顿90)
	...
	{ OPTION_UI_BORDER_COLOR,               "ffb41010",     OPTION_STRING,      "UI border color (ARGB)" }, // 修改的 (加斯顿90)
	{ OPTION_UI_BACKGROUND_COLOR,           "ef161616",     OPTION_STRING,      "UI background color (ARGB)" }, // 修改的 (加斯顿90)
	{ OPTION_UI_CLONE_COLOR,                "ffc6c6c6",     OPTION_STRING,      "UI clone color (ARGB)" }, // 修改的 (加斯顿90)
	...
	{ OPTION_UI_SLIDER_COLOR,               "efffffff",     OPTION_STRING,      "UI slider color (ARGB)" }, // 修改的 (加斯顿90)
	{ OPTION_UI_SUBITEM_COLOR,              "efffffff",     OPTION_STRING,      "UI subitem color (ARGB)" }, // 修改的 (加斯顿90)
	{ OPTION_UI_TEXT_BG_COLOR,              "efefefef",     OPTION_STRING,      "UI text bg color (ARGB)" },
	{ OPTION_UI_TEXT_COLOR,                 "ffffffff",     OPTION_STRING,      "UI text color (ARGB)" }, // 修改的 (加斯顿90)
