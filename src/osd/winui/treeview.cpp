...
void CreateDECRYPTEDFolders(int parent_index)
{
	...
	for (jj = 0; jj < nGames; jj++)
	{
		...
		if (!strcmp("ct2k3spdp", s))			    AddGame(lpFolder, jj);
		...
		if (!strcmp("kf2k2plb", s))			        AddGame(lpFolder, jj);
		...
		if (!strcmp("kf2k2plcp", s))		        AddGame(lpFolder, jj);
		...
		if (!strcmp("kf2k2sple", s))			    AddGame(lpFolder, jj);
		...
		if (!strcmp("kf2k2spld", s))			    AddGame(lpFolder, jj);
		...
		if (!strcmp("kf2k3bl2", s))			        AddGame(lpFolder, jj);
		...
		if (!strcmp("kf2k5unip", s))			    AddGame(lpFolder, jj);
		if (!strcmp("kf2k8uni", s))			        AddGame(lpFolder, jj);
		if (!strcmp("kf2k8unid", s))			    AddGame(lpFolder, jj);
		if (!strcmp("kof10thu", s))			        AddGame(lpFolder, jj);
		if (!strcmp("kof10thud", s))			    AddGame(lpFolder, jj);
		if (!strcmp("kof2k4mp", s))			        AddGame(lpFolder, jj);
		if (!strcmp("kof2k4mp2", s))			    AddGame(lpFolder, jj);
		if (!strcmp("kofse2k4e", s))			    AddGame(lpFolder, jj);
		if (!strcmp("kf2k4plae", s))			    AddGame(lpFolder, jj);
		if (!strcmp("kf2k4plbe", s))			    AddGame(lpFolder, jj);
		if (!strcmp("kofse2k4d", s))			    AddGame(lpFolder, jj);
		if (!strcmp("kf2k4plad", s))		        AddGame(lpFolder, jj);
		if (!strcmp("kf2k4plbd", s))			    AddGame(lpFolder, jj);
		...
		if (!strcmp("matrima", s))			        AddGame(lpFolder, jj);
		if (!strcmp("matrimap", s))			        AddGame(lpFolder, jj);
		if (!strcmp("matrimeh", s))			        AddGame(lpFolder, jj);
		...
		if (!strcmp("samsh5p", s))			        AddGame(lpFolder, jj);
