...
void CreateNEOSDFolders(int parent_index)
{
	...
	for (jj = 0; jj < nGames; jj++)
	{
		...
		if (!strcmp("vlinernds", s))			        AddGame(lpFolder, jj);
		if (!strcmp("vliner7ends", s))			        AddGame(lpFolder, jj);
		if (!strcmp("vliner6ends", s))			        AddGame(lpFolder, jj);
		if (!strcmp("vliner54nds", s))			        AddGame(lpFolder, jj);
		if (!strcmp("vliner53nds", s))			        AddGame(lpFolder, jj);
...
void CreateHOMEBREWFolders(int parent_index)
{
	...
	for (jj = 0; jj < nGames; jj++)
	{
		...
		if (!strcmp("68kng", s))			        AddGame(lpFolder, jj);
		...
		if (!strcmp("chelnovn", s))			        AddGame(lpFolder, jj);
		...
		if (!strcmp("knacki", s))			        AddGame(lpFolder, jj);
		if (!strcmp("ndo_a_td", s))			        AddGame(lpFolder, jj);
		...
		if (!strcmp("ngtd2", s))			        AddGame(lpFolder, jj);
		if (!strcmp("ngtetris", s))		            AddGame(lpFolder, jj);
		if (!strcmp("ngym2610", s))		            AddGame(lpFolder, jj);
		if (!strcmp("nsmbd", s))			        AddGame(lpFolder, jj);
		if (!strcmp("nsmb", s))			            AddGame(lpFolder, jj);
		if (!strcmp("nyan", s))			            AddGame(lpFolder, jj);
		if (!strcmp("pcmademo", s))			        AddGame(lpFolder, jj);
		if (!strcmp("pcmbdemo", s))			        AddGame(lpFolder, jj);
		if (!strcmp("poknight", s))			        AddGame(lpFolder, jj);
		if (!strcmp("pown", s))			            AddGame(lpFolder, jj);
		if (!strcmp("raroggame", s))			    AddGame(lpFolder, jj);
		if (!strcmp("samantha", s))			        AddGame(lpFolder, jj);
		if (!strcmp("santabll", s))			        AddGame(lpFolder, jj);
		if (!strcmp("sgz", s))			            AddGame(lpFolder, jj);
		if (!strcmp("shaman24", s))			        AddGame(lpFolder, jj);
		if (!strcmp("shinobin", s))			        AddGame(lpFolder, jj);
		if (!strcmp("seafight", s))			        AddGame(lpFolder, jj);
		if (!strcmp("snddemo", s))			        AddGame(lpFolder, jj);
		if (!strcmp("spkick", s))			        AddGame(lpFolder, jj);
		if (!strcmp("spriteex", s))			        AddGame(lpFolder, jj);
...
void CreateMUSICFolders(int parent_index)
{
	...
	for (jj = 0; jj < nGames; jj++)
	{
		...
		if (!strcmp("akiradmo", s))			    AddGame(lpFolder, jj);
...
void CreateNEOGEOCDFolders(int parent_index)
{
	...
	for (jj = 0; jj < nGames; jj++)
	{
		...
		if (!strcmp("fr2cd", s))			        AddGame(lpFolder, jj);
