...
GAME( 1982, btime,    0,       btime,    btime,    btime_state, init_btime,    ROT270, "Data East Corporation",                "Burger Time (Data East set 1)",  MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
...
GAME( 1981, lnc,      0,       lnc,      lnc,      btime_state, init_lnc,      ROT270, "Data East Corporation",                "Lock'n'Chase",                   MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
...
GAME( 1982, brubber,  0,       bnj,      brubber,  btime_state, init_bnj,      ROT270, "Data East",                            "Burnin' Rubber",                 MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
