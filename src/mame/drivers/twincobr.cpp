...
GAME( 1987, twincobr,  0,        twincobrw, twincobr,  twincobr_state, init_twincobr, ROT270, "Toaplan / Taito Corporation",                           "Twin Cobra (World)",                    MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
