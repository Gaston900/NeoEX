...
GAME( 1994, primrage,   0,        primrage,   primrage, atarigt_state, init_primrage, ROT0, "Atari Games", "Primal Rage (version 2.3)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE | MACHINE_UNEMULATED_PROTECTION )
