...
GAME( 1995, srallyc,    0,        srallyc,      srallyc,   model2a_state, empty_init,    ROT0, "Sega",   "Sega Rally Championship - Twin/DX (Revision C)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE |MACHINE_IMPERFECT_GRAPHICS )
