...
GAME( 1980, targ,      0,       targ,     targ,      targ_state,    init_targ,     ROT0, "Exidy",   "Targ", MACHINE_IMPERFECT_SOUND | MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
...
GAME( 1980, spectar,   0,       spectar,  spectar,   spectar_state, init_spectar,  ROT0, "Exidy",   "Spectar (revision 3)", MACHINE_IMPERFECT_SOUND | MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
...
GAME( 1982, teetert,   0,       teetert,  teetert,   teetert_state, empty_init,    ROT0, "Exidy",   "Teeter Torture (prototype)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
