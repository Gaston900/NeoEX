...
GAME(  1983, tapper,    0,        mcr_91490,     tapper,    mcr_state,         init_mcr_91490, ROT0,  "Bally Midway", "Tapper (Budweiser, 1/27/84)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE ) /* Date from program ROM labels - Newest version */
