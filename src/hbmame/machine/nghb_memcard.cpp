...
std::pair<std::error_condition, std::string> nghb_memcard_device::call_load()
{
	if(length() != 0x800)
...
std::pair<std::error_condition, std::string> nghb_memcard_device::call_create(int format_type, util::option_resolution *format_options)
{
