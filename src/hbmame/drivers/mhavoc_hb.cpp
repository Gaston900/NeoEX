...
//RELEASE BUILDS
GAME( 2022, mhavocpe,     mhavoc, mhavocpe_adpcm, mhavocpe_inputs, mhavoc_hbmame, empty_init, ROT0, "JMA", "Major Havoc - The Promised End (v1.01) English - ADPCM Speech", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2022, mhavocpefr,   mhavoc, mhavocpe_adpcm, mhavocpe_inputs, mhavoc_hbmame, empty_init, ROT0, "JMA", "Major Havoc - The Promised End (v1.01) French - ADPCM Speech", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2022, mhavocpede,   mhavoc, mhavocpe_adpcm, mhavocpe_inputs, mhavoc_hbmame, empty_init, ROT0, "JMA", "Major Havoc - The Promised End (v1.01) German - ADPCM Speech", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2022, mhavocpete,     mhavoc, mhavocpe_adpcm, mhavocpe_inputs, mhavoc_hbmame, empty_init, ROT0, "JMA", "Major Havoc - The Promised End - Tournament (v1.01) English - ADPCM Speech", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2022, mhavocpefrte,   mhavoc, mhavocpe_adpcm, mhavocpe_inputs, mhavoc_hbmame, empty_init, ROT0, "JMA", "Major Havoc - The Promised End - Tournament (v1.01) French - ADPCM Speech", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2022, mhavocpedete,   mhavoc, mhavocpe_adpcm, mhavocpe_inputs, mhavoc_hbmame, empty_init, ROT0, "JMA", "Major Havoc - The Promised End - Tournament (v1.01) German - ADPCM Speech", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
