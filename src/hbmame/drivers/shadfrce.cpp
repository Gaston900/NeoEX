...
/* Shadfrce Hack */
GAME( 1993, shadfrcehc01,   shadfrce,  shadfrce, shadfrce, shadfrce_state, empty_init,   ROT0,    "hack",       "Shadow Force (Enable Hidden Characters)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
