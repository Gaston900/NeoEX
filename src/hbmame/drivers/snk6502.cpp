...
/* Snk6502 HomeBrew */
GAME( 1998, vantris,    0,    vanguard, vanguard, vanguard_state, empty_init, ROT90, "Norbert Kehrer", "Vantris 98", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE ) // http://web.utanet.at/nkehrer/vantris.html
