...
/* Konamigx Hack */
GAME( 1995, dragoonahc01,  dragoona, dragoonj,  dragoonj, konamigx_state, init_posthack, ROT0,    "hack",        "Dragoon Might (Enable Hidden Character)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1995, dragoonahc02,  dragoona, dragoonj,  dragoonj, konamigx_state, init_posthack, ROT0,    "hack",        "Dragoon Might (Always Have Super Move)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1995, dragoonahc03,  dragoona, dragoonj,  dragoonj, konamigx_state, init_posthack, ROT0,    "hack",        "Dragoon Might (Easy Special Attacks)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
