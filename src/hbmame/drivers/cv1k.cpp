...
/* Cv1k Hack */
GAME( 2010, akatana,     0,        cv1k_d, cv1k, cv1k_state, init_ddpdfk,   ROT0,   "Cave",       "Akai Katana (2010-08-13 MASTER VER.)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2007, deathsml01,  deathsml, cv1k,   cv1k, cv1k_state, init_deathsml, ROT0,   "Cave (AMI license)", "Death Smiles (Hidden Elements Full Open + Character Enhancement)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2012, ddpsdoj,     0,        cv1k_d, cv1k, cv1k_state, init_ddpdfk,   ROT270, "Cave",       "DoDonPachi SaiDaiOuJou (Clean Dump)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2012, ddpsdojo,    ddpsdoj,  cv1k_d, cv1k, cv1k_state, init_ddpdfk,   ROT270, "Cave",       "DoDonPachi SaiDaiOuJou (Dirty Dump)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2021, sdojak,      0,        cv1k_d, cv1k, cv1k_state, init_ddpdfk,   ROT270, "CaveDwellers", "DoDonPachi SaiDaiOuJou & Knuckles (2021-12-01)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2021, sdoja,       sdojak,   cv1k_d, cv1k, cv1k_state, init_ddpdfk,   ROT270, "hack",       "DoDonPachi SaiDaiOuJou hack", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2022, sdojb,       sdojak,   cv1k_d, cv1k, cv1k_state, init_ddpdfk,   ROT270, "hack",       "DoDonPachi SaiDaiOuJou Saya Type B (2022-01-06)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2005, ibaracs,     ibara,    cv1k,   cv1ks,cv1k_state, init_ibara,    ROT270, "ArcCabView", "Ibara (2005-03-22 MASTER VER.. COLOR SAT)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2006, ibarablkcs,  ibarablk, cv1k,   cv1ks,cv1k_state, init_pinkswts, ROT270, "ArcCabView", "Ibara Kuro Black Label (2006-02-06. MASTER VER. COLOR SAT)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2022, futari15bc,  futari15, cv1k,   cv1k, cv1k_state, init_pinkswts, ROT270, "ArcCabView", "Mushihime-Sama Futari Ver 1.5 (2006-12-08.MASTER VER. 1.54. BLK COLOR)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2022, futariblc,   futaribl, cv1k,   cv1k, cv1k_state, init_pinkswts, ROT270, "ArcCabView", "Mushihime-Sama Futari Black Label - Another Ver (2009-11-27 INTERNATIONAL BL - ORIG COLOR)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2022, futaribljc,  futaribl, cv1k,   cv1k, cv1k_state, init_pinkswts, ROT270, "ArcCabView", "Mushihime-Sama Futari Black Label (2007-12-11 BLACK LABEL VER - ORIG COLOR)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
