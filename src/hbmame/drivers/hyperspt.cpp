...
/* Hyperspt HomeBrew */
GAME( 2017, hypetest, hyperspt, hyperspt, hyperspt, hyperspt_state, empty_init, ROT0,  "Shoestring", "Hyper Sports Test Rom (HB)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
