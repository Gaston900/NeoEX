...
/* Rallyx Hack */
GAME( 1998, rallyxhc01,  rallyx, rallyx, rallyx,  rallyx_state, empty_init,   ROT0,  "hack",         "Rally-X Tron", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1981, rallyxhc02,  rallyx, rallyx, nrallyv, rallyx_state, empty_init,   ROT90, "hack",         "New Rally X (Vertical Screen)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
