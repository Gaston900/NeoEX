...
/* Asuka Hack */
GAME( 2007, c2frog,     0,       segac, columns, segac2_state, init_columns, ROT0, "Rastersoft", "Frog Feast (Sega C2 hardware) (HB)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE | MACHINE_NO_SOUND )
