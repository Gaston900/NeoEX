...
GAME( 1981, galagab2, galaga,  galaga,   galaga,   galaga_state,  init_galaga,  ROT90, "bootleg", "Galaga (bootleg)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1982, galagabl, galaga,  galaga,   galaga,   galaga_state,  init_galaga,  ROT90, "bootleg", "Galaga (Namco 1982)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1981, galagads, galaga,  galaga,   galagamw, galaga_state,  init_galaga,  ROT90, "hack", "Galaga (fast shoot)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, galagaef, galaga,  galaga,   galagamw, galaga_state,  init_galaga,  ROT90, "hack", "Galaga (Enduring Freedom)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
...
GAME( 2000, terror,   galaga,  galaga,   galaga,   galaga_state,  init_galaga,  ROT90, "Hack", "Terrorist", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, vgalaga,  galaga,  galaga,   galaga,   galaga_state,  init_galaga,  ROT90, "Hack", "Vector Galaga", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, vgalagam, galaga,  galaga,   galaga,   galaga_state,  init_galaga,  ROT90, "Hack", "Vector Galaga Midway", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, vgalagaf, galaga,  galaga,   galaga,   galaga_state,  init_galaga,  ROT90, "Hack", "Vector Galaga Fast Shoot", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2002, battlesh, xevious, battles,  xevious,  battles_state, driver_init,  ROT90, "bootleg", "Battles 2002", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2005, gaous,    xevious, xevious,  xevious,  xevious_state, init_xevious, ROT90, "Namco (Hack)", "Gaous", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2002, sxvioush, xevious, xevious,  sxevious, xevious_state, init_xevious, ROT90, "Namco", "Super Xevious 2002", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2004, xeviblk,  xevious, xevious,  xevious,  xevious_state, init_xevious, ROT90, "Namco", "Xevious Black", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2002, xevious3, xevious, xevious,  xevious,  xevious_state, init_xevious, ROT90, "Namco", "Xevious 2003", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
