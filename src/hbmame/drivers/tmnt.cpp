...
/* Asuka Hack */
GAME( 2009, ssridershc01, ssriders, ssriders, ssriders,  tmnt_state, empty_init, ROT0,   "hack",   "Sunset Riders (Enable Hidden Characters)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2019, ssridershc02, ssriders, ssriders, ssridr4p,  tmnt_state, empty_init, ROT0,   "GOTVG",  "Sunset Riders (1V4 2019-07-29)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2019, ssridershc03, ssriders, ssriders, ssridr4p,  tmnt_state, empty_init, ROT0,   "GOTVG",  "Sunset Riders (Second Round 2019-04-20)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2022, ssridershc04, ssriders, ssriders, ssridr4p,  tmnt_state, empty_init, ROT0,   "GOTVG",  "Sunset Riders (Firepower 2022-06-27)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1991, tmnt2hc01,    tmnt2,    tmnt2,    ssrid4ps,  tmnt_state, empty_init, ROT0,   "hack",   "Teenage Mutant Ninja Turtles (Switchable Character)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
