...
/* Tehkanwc Hack */
GAME( 1985, ballonwc, tehkanwc, tehkanwc, tehkanwc, tehkanwc_state, empty_init, ROT0,  "Grand Master Peter", "Ballon World Cup", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2003, tankwc,   tehkanwc, tehkanwc, tehkanwc, tehkanwc_state, empty_init, ROT0,  "Kazzy",     "Tank World Cup", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2004, twc_gr,   tehkanwc, tehkanwc, tehkanwc, tehkanwc_state, empty_init, ROT0,  "GreekRoms", "Tehkan World Cup (Greek Translation)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
