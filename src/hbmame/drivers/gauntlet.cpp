...
/* Gauntlet Hack */
GAME( 1987, gaunt2hc01,  gaunt2,   gauntlet2, gauntlet, gauntlet_state, init_gauntlet,   ROT0, "Todd Bordelon",        "Gauntlet II (Speed Hack)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE ) // http://www.ionpool.net/arcade/gauntlet/hacks.html
GAME( 1988, gaunt2hc02,  gaunt2,   gauntlet2, gauntlet, gauntlet_state, init_gauntlet,   ROT0, "Carl Lloyd-Parker",    "Gauntlet II (New Levels)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1986, gaunt2hc03,  gaunt2,   gauntlet2, gauntlet, gauntlet_state, init_gauntlet,   ROT0, "hack",                 "Gauntlet II (Graphics Hack)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
