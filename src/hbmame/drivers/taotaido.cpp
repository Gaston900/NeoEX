...
/* Taotaido Hack */
GAME( 1993, taotaidohc01, taotaido, taotaido, taotaido6, taotaido_state, empty_init,  ROT0,     "DDJ",       "Tao Taido (Easy Special Attacks)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
