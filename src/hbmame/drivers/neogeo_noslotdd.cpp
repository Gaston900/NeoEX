...
GAME( 2003, ct2k3sadd,    kof2001,  neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "bootleg (Phenixsoft)", "Crouching Tiger Hidden Dragon 2003 Super Plus alternate (The King of Fighters 2001 bootleg) (Darksoft)", MACHINE_SUPPORTS_SAVE ) /* Hack / Bootleg of kof2001 */
GAME( 2003, ct2k3spdd,    kof2001,  neogeo_noslot,   neogeo, neogeo_state,   init_ct2k3spdd,  ROT0, "bootleg (Phenixsoft)", "Crouching Tiger Hidden Dragon 2003 Super Plus (The King of Fighters 2001 bootleg) (Darksoft)", MACHINE_SUPPORTS_SAVE ) /* Protected Hack / Bootleg of kof2001 */
GAME( 2003, cthd2003dd,   kof2001,  neogeo_noslot,   neogeo, neogeo_state,   init_cthd2003dd, ROT0, "bootleg (Phenixsoft)", "Crouching Tiger Hidden Dragon 2003 (The King of Fighters 2001 bootleg, set 1) (Darksoft)", MACHINE_SUPPORTS_SAVE ) /* Protected Hack / Bootleg of kof2001 */
...
GAME( 1994, fightfevdd,   fightfev, neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "Viccom", "Fight Fever / Wang Jung Wang (set 1) (Darksoft)", MACHINE_SUPPORTS_SAVE )
GAME( 1994, fightfevadd,  fightfev, neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "Viccom", "Fight Fever / Wang Jung Wang (set 2) (Darksoft)", MACHINE_SUPPORTS_SAVE )
...
GAME( 1991, burningfpnds,  burningf, neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "SNK", "Burning Fight (prototype, older) (Neo SD)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, burningfpands, burningf, neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "SNK", "Burning Fight (prototype, near final, ver 23.3, 910326) (Neo SD)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, crswd2blnds,   crswd2bl, neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "bootleg (Razoola)", "Crossed Swords 2 (bootleg of CD version) (Neo SD)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2003, ct2k3sands,    kof2001,  neogeo_noslot,   neogeo, neogeo_state,   init_ct2k3sadd,  ROT0, "bootleg (Phenixsoft)", "Crouching Tiger Hidden Dragon 2003 Super Plus alternate (The King of Fighters 2001 bootleg) (Neo SD)", MACHINE_SUPPORTS_SAVE ) /* Hack / Bootleg of kof2001 */
GAME( 2003, ct2k3spnds,    kof2001,  neogeo_noslot,   neogeo, neogeo_state,   init_ct2k3spdd,  ROT0, "bootleg (Phenixsoft)", "Crouching Tiger Hidden Dragon 2003 Super Plus (The King of Fighters 2001 bootleg) (Neo SD)", MACHINE_SUPPORTS_SAVE ) /* Protected Hack / Bootleg of kof2001 */
GAME( 2003, cthd2003nds,   kof2001,  neogeo_noslot,   neogeo, neogeo_state,   init_cthd2003dd, ROT0, "bootleg (Phenixsoft)", "Crouching Tiger Hidden Dragon 2003 (The King of Fighters 2001 bootleg, set 1) (Neo SD)", MACHINE_SUPPORTS_SAVE ) /* Protected Hack / Bootleg of kof2001 */
...
GAME( 1994, fightfevnds,   fightfev, neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "Viccom", "Fight Fever / Wang Jung Wang (set 1) (Neo SD)", MACHINE_SUPPORTS_SAVE )
GAME( 1994, fightfevands,  fightfev, neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "Viccom", "Fight Fever / Wang Jung Wang (set 2) (Neo SD)", MACHINE_SUPPORTS_SAVE )
GAME( 1998, flipshotnds,   flipshot, neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "Visco", "Flip Shot (Neo SD)", MACHINE_SUPPORTS_SAVE )
...
GAME( 1994, janshinnds,    janshin,  neogeo_mahjong,  mahjong,neogeo_state,   init_darksoft,   ROT0, "Aicom", "Janshin Densetsu - Quest of Jongmaster (Neo SD)", MACHINE_SUPPORTS_SAVE )
...
GAME( 1997, kof97oronds,   kof97,    neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "bootleg", "The King of Fighters '97 Chongchu Jianghu Plus 2003 (bootleg) (Neo SD)", MACHINE_SUPPORTS_SAVE )
...
GAME( 1998, kof98knds,     kof98,    neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "SNK", "The King of Fighters '98 - The Slugfest / King of Fighters '98 - Dream Match Never Ends (Korean board, set 1) (Neo SD)", MACHINE_SUPPORTS_SAVE )
GAME( 1998, kof98kands,    kof98,    neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "SNK", "The King of Fighters '98 - The Slugfest / King of Fighters '98 - Dream Match Never Ends (Korean board, set 2) (Neo SD)", MACHINE_SUPPORTS_SAVE )
...
GAME( 1991, legendosnds,   legendos, neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "SNK / Wave", "Legend of Success Joe / Ashita no Joe Densetsu (Neo SD)", MACHINE_SUPPORTS_SAVE )
...
GAME( 1996, mslugnsd,      mslug,    neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "Nazca", "Metal Slug - Super Vehicle-001 (Neo SD)", MACHINE_SUPPORTS_SAVE )
GAME( 1998, mslug2nsd,     mslug2,   neoclock_noslot, neogeo, neogeo_state,   init_darksoft,   ROT0, "SNK", "Metal Slug 2 - Super Vehicle-001/II (Neo SD)", MACHINE_SUPPORTS_SAVE )
GAME( 1998, mslug2tnsd,    mslug2,   neoclock_noslot, neogeo, neogeo_state,   init_darksoft,   ROT0, "SNK", "Metal Slug 2 Turbo - Super Vehicle-001/II (Neo SD)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2002, mslug4nsd,     mslug4,   neogeo_noslot,   neogeo, neogeo_state,   init_mslug4dd,   ROT0, "Mega / Noise Factory / Playmore", "Metal Slug 4 (NGM-2630) (Neo SD)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, mslug4hnsd,    mslug4,   neogeo_noslot,   neogeo, neogeo_state,   init_mslug4dd,   ROT0, "Mega / Noise Factory / Playmore", "Metal Slug 4 (NGH-2630) (Neo SD)", MACHINE_SUPPORTS_SAVE )
...
GAME( 1999, mslugxnsd,     mslugx,   neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "SNK", "Metal Slug X - Super Vehicle-001 (Neo SD)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, minasannds,    minasan,  neogeo_mahjong,  mahjong,neogeo_state,   init_darksoft,   ROT0, "Monolith Corp.", "Minasan no Okagesamadesu! Dai Sugoroku Taikai (MOM-001 ~ MOH-001) (Neo SD)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, moshouginds,   moshougi, neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "ADK / SNK", "Shougi no Tatsujin - Master of Shougi (Neo SD)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2003, pnyaands,      pnyaa,    neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "Aiky / Taito", "Pochi and Nyaa (Ver 2.02) (Neo SD)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, pnyaaands,     pnyaa,    neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "Aiky / Taito", "Pochi and Nyaa (Ver 2.00) (Neo SD)", MACHINE_SUPPORTS_SAVE ) // this version does not show the web address on the title screen
...
GAME( 1999, preisle2nds,   preisle2, neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "Yumekobo / Saurus", "Prehistoric Isle 2 (Neo SD)", MACHINE_SUPPORTS_SAVE )
...
GAME( 1997, puzzldprnds,   puzzledp, neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "Visco", "Puzzle De Pon! R! (Neo SD)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, puzzledpnds,   puzzledp, neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "Visco", "Puzzle De Pon! (Neo SD)", MACHINE_SUPPORTS_SAVE )
...
GAME( 1995, quizdaisknds,  quizdais, neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "SNK / Viccom", "Quiz Salibtamjeong - The Last Count Down (Korean localized Quiz Daisousa Sen) (Neo SD)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, quizkofnds,    quizkof,  neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "Saurus (SNK license)", "Quiz King of Fighters (SAM-080 ~ SAH-080) (Neo SD)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, quizkofknds,   quizkof,  neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "Saurus / Viccom (SNK license)", "Quiz King of Fighters (Korea) (Neo SD)", MACHINE_SUPPORTS_SAVE )
...
GAME( 1996, samsho4knds,   samsho4,  neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "SNK", "Paewang Jeonseol / Legend of a Warrior (Korean censored Samurai Shodown IV) (Neo SD)", MACHINE_SUPPORTS_SAVE )
...
GAME( 1995, ssideki3nds,   ssideki3, neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "SNK", "Super Sidekicks 3 - The Next Glory / Tokuten Ou 3 - Eikou e no Chousen (Neo SD)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2003, svcnds,        svc,      neogeo_noslot,   neogeo, neogeo_state,   init_svcdd,      ROT0, "Playmore / Capcom", "SNK vs. Capcom - SVC Chaos (NGM-2690 ~ NGH-2690) (Neo SD)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2001, vlinernds,     vliner,   neogeo_noctrl,   vliner, neogeo_state,   init_vlinerdd,   ROT0, "Dyna / BrezzaSoft", "V-Liner (v0.7a) (Neo SD)", MACHINE_SUPPORTS_SAVE )
