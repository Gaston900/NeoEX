...
/* Legionna Hack */
GAME( 1994, denjinmkhc01,  denjinmk,   denjinmk, denjinmk, legionna_state, empty_init,     ROT0,   "DDJ",        "Denjin Makai (Easy Special Attacks)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
