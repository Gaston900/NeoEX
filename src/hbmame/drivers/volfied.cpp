...
// Volfied
GAME( 2005, volfiedhc01,    volfied, volfied, volfied, volfied_state, empty_init, ROT270, "hack",             "Volfied (Translation Greek)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
