...
/* Segaorun Hack */
GAMEL(2016, outrunhc01,   outrun,   outrunm, outrun, outrunm_state,  init_init,     ROT0,   "Cmonkey",           "Out Run (sitdown/upright, Rev B) (Added Music)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE, layout_outrun ) // March? 2016
GAME( 2017, outrunt1,     outrun,   outrun,  outrun, segaorun_state, init_outrun,   ROT0,   "Alex Bartholomeus", "Out Run (Memory Test v0.1) (HB)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2017, toutrundt1,   toutrun,  outrun,  toutrun,segaorun_state, init_outrun,   ROT0,   "Alex Bartholomeus", "Turbo Out Run (Ram Test v0.1) (HB)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
