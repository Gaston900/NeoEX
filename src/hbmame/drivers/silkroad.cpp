...
/* Silkroad Hack */
GAME( 1999, silkroadhc01,  silkroad,   silkroad, silkroad, silkroad_state, empty_init, ROT0,  "DDJ",       "The Legend of Silkroad (All Move Without Magic)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1999, silkroadhc02,  silkroad,   silkroad, silkroad, silkroad_state, empty_init, ROT0,  "DDJ",       "The Legend of Silkroad (Easy Special Attacks)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2020, silkroadhc03,  silkroad,   silkroad, silkroad, silkroad_state, empty_init, ROT0,  "GOTVG",     "The Legend of Silkroad (1V2 2020-12-07)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
