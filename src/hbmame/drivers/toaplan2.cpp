...
/* Toaplan2 Hack */
GAME( 1996, bgareggahc01,  bgaregga, bgaregga, bgaregga,   toaplan2_state, init_bgaregga, ROT270,  "hack",       "Battle Garegga (Enable Hidden Characters)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1993, mahoudaihc01,  sstriker, mahoudai, mahoudai,   toaplan2_state, empty_init,    ROT270,  "hack",       "Mahou Daisakusen (Translation Chinese)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1994, snowbro2hc01,  snowbro2, snowbro2, snowbro2,   toaplan2_state, empty_init,    ROT0,    "hack",       "Snow Bros 2 (Infinite Power)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1994, snowbro2hc02,  snowbro2, snowbro2, snowbro2,   toaplan2_state, empty_init,    ROT0,    "hack",       "Snow Bros 2 (Switchable Character)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
