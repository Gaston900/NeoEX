...
/* Tecmosys Hack */
GAME( 1996, tkdenshohc01,  tkdensho, tecmosys, tecmosys, tecmosys_state, init_tkdensho,   ROT0,   "hack",       "Toukidenshou (Enable Hidden Characters)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1996, tkdenshohc02,  tkdensho, tecmosys, tecmosys, tecmosys_state, init_tkdensho,   ROT0,   "DDJ",        "Toukidenshou (Always Have Super Move)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1996, tkdenshohc03,  tkdensho, tecmosys, tecmosys, tecmosys_state, init_tkdensho,   ROT0,   "DDJ",        "Toukidenshou (Easy Special Attacks)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
