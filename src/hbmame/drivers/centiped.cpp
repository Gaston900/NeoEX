...
/* Centiped Hack */
GAME( 2002, astropd2, centiped, centiped, centiped, centiped_state, empty_init, ROT270, "Twisty",  "Astropede II", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2002, astroped, centiped, centiped, centiped, centiped_state, empty_init, ROT270, "Twisty",  "Astropede", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1998, cemescry, centiped, centiped, centiped, centiped_state, empty_init, ROT270, "NoSync",  "Cemescary", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1998, killiped, centiped, centiped, centiped, centiped_state, empty_init, ROT270, "The Dog", "Killipede", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1980, magworm2, centiped, magworm,  magworm,  centiped_state, empty_init, ROT270, "bootleg", "Magic Worm", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, pacipede, centiped, centiped, centiped, centiped_state, empty_init, ROT270, "Jeff Coleburn", "Pacipede", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1998, silliped, milliped, milliped, milliped, centiped_state, empty_init, ROT270, "Andy",    "Sillipede", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1998, vectiped, centiped, centiped, centiped, centiped_state, empty_init, ROT270, "The Dog", "Vectipede", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1998, vectrped, centiped, centiped, centiped, centiped_state, empty_init, ROT270, "T-Bone",  "Vectorpede", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
