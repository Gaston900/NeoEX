...
/* Segaxbd HomeBrew */
GAME( 2020, aburtest, aburner2, sega_aburner2,  aburner,  segaxbd_new_state, init_aburner2, ROT0,   "Chris White", "After Burner Test Rom (HB)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
