...
/* Mystwarr Hack */
GAME( 1993, mtlchamhc01,   mtlchamp,   martchmp, martchmp, mystwarr_state, empty_init, ROT0,   "DDJ",        "Martial Champion (Easy Special Attacks)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1993, mmaulershc01,  mmaulers,   dadandrn, dadandrn, mystwarr_state, empty_init, ROT0,   "DDJ",        "Monster Maulers (Easy Special Attacks)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2018, viostormhc01,  viostorm,   viostorm, viostorm, mystwarr_state, empty_init, ROT0,   "GOTVG",      "Violent Storm (1V3 2018-05-07)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2021, viostormhc02,  viostorm,   viostorm, viostorm, mystwarr_state, empty_init, ROT0,   "GOTVG",      "Violent Storm (Enhanced Prosperity 2021-01-27)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2018, viostormhc03,  viostorm,   viostorm, viostorm, mystwarr_state, empty_init, ROT0,   "hack",       "Violent Storm (Increased Health 2018-08-13)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
