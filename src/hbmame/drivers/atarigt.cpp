...
/* Atarigt Hack */
GAME( 2020, primragehc01,     primrage, primrage, primrage, atarigt_state, init_primrage, ROT0, "Gruntzilla94", "Primal Rage (version X.0)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2022, primragehc02,     primrage, primrage, primrage, atarigt_state, init_primrage, ROT0, "Gruntzilla94", "Primal Rage (Hack Menu)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
