...
/* Ssv Hack */
GAME( 1993,  survartshc01,  survarts,  survarts, survarts, ssv_state, init_ssv,   ROT0,   "DDJ",       "Survival Arts (Easy Special Attacks)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
