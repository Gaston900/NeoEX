...
/* Pooyan HomeBrew */
GAME( 2017, pooytest,  pooyan, pooyan, pooyan, pooyan_state, empty_init, ROT90,  "Shoestring", "Pooyan Diagnostig Test (HB)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2017, pooytest2, pooyan, pooyan, pooyan, pooyan_state, empty_init, ROT90,  "Shoestring", "Pooyan Test Rom (HB)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
