...
/* Rohga Hack */
GAME( 1993, schmeisrhc01, schmeisr,  schmeisr, schmeisr, rohga_state, init_schmeisr, ROT0,   "hack",   "Schmeiser Robo (Enable Hidden Characters)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
