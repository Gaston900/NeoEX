...
GAME( 1981, mspacman, 0,        mspacman, mspacpls, puckman_state, init_mspacman,    ROT90, "Midway", "Ms. Pacman", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1981, mspacmat, mspacman, mspacman, mspacman, puckman_state, init_mspacman,    ROT90, "hack", "Ms. Pac Attack", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1981, mspacmab, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "bootleg", "Ms. Pacman (bootleg)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1981, mspacmbe, mspacman, woodpek,  mspacman, puckman_state, init_mspacmbe,    ROT90, "bootleg", "Ms. Pacman (bootleg, (encrypted))", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1981, mspacmnf, mspacman, mspacman, mspacman, puckman_state, init_mspacman,    ROT90, "Midway", "Ms. Pacman (with speedup hack)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1981, mspacpls, mspacman, woodpek,  mspacpls, puckman_state, empty_init,  ROT90, "hack", "Ms. Pacman Plus", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1981, pacgal,   mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "hack", "Pac-Gal", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2017, mspacmabscre, mspacman, woodpek,  mspacman, puckman_state, empty_init, ROT90, "Mameplus", "Ms. Pacman (Split Screen Solved)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )

/* Dave Widel's Games - http://www.widel.com */

GAME( 2003, mrmrspac, mspacman, widel,    mspacpls, puckman_state, empty_init,  ROT90, "David Widel", "Mr and Mrs Pacman (MR MRS PAC-MAN)[c]", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1998, mspachi,  mspacman, mspachi,  mspacpls, puckman_state, empty_init,  ROT90, "David Widel", "Ms. Pacman[h]", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, pacatk,   mspacman, mspacman, mspacpls, puckman_state, init_mspacman,    ROT90, "David Widel", "Ms. Pacman Plus (Fruit)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )

/* Blue Justice's Hacks */

GAME( 2001, ms1000,   mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Blue Justice", "Ms. Pacman 1000 (MS PAC-MAN 1000)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2001, ms2000,   mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Blue Justice", "Ms. Pacman 2000 (MS PAC-MAN 2000)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2001, ms3000,   mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Blue Justice", "Ms. Pacman 3000 (MS PAC-MAN 3000)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2001, ms4000p,  mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Blue Justice", "Ms. Pacman 4000 Plus (MSPAC-MAN 4000PLUS)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2001, ms5000,   mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Blue Justice", "Ms. Pacman 5000 (MS PAC-MAN 5000)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2001, ms5000p,  mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Blue Justice", "Ms. Pacman 5000 Plus (MSPAC-MAN 5000PLUS)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2001, mscrzyma, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Blue Justice", "Ms. Pacman Crazy Mazes (MS PAC CRAZY MAZES)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2001, mscrzymp, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Blue Justice", "Ms. Pacman Crazy Mazes Plus (MS PAC-MAN CRAZYPLUS)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2001, msextra,  mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Blue Justice", "Ms. Pacman Extra (MS PAC-MAN EXTRA)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2001, msextrap, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Blue Justice", "Ms. Pacman Extra Plus (MS PAC-MAN EXTRAPLUS)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2001, msmspac,  mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Blue Justice", "Ms. Pacman Ms. Pac (MS PAC-MAN MS PAC)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2001, mspacdel, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Blue Justice", "Ms. Pacman Deluxe (MS PAC-MAN DELUXE)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2001, mspamsba, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Blue Justice", "Ms. Pacman Ms. Babies (MS PAC-MAN MS BABIES)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2001, mspacp,   mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Blue Justice", "Ms. Pacman Plus (MS PAC-MAN PLUS)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2001, msplus,   mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Blue Justice", "Ms. Pacman Ms Plus (MS PAC-MAN MS PLUS)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2001, msstrmaz, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Blue Justice", "Ms. Pacman Strange Mazes (MS PAC STRANGE MAZES)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )

/* T-Bone Hacks */

GAME( 2000, ms2600,   mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "T-Bone", "Ms. Pacman 2600", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, msbaby,   mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "T-Bone", "Ms. Baby Pacman", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
...
GAME( 2004, horizpab, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT0,  "Scott Lawrence", "Horiz Pac (v1.0)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2004, horizpac, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT0,  "Scott Lawrence", "Horiz Pac", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2007, pacgent,  mspacman, woodpek,  mspacpls, puckman_state, empty_init,  ROT90, "Scott Lawrence", "Pac Gentleman [f]", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2004, ramsnoop, mspacman, woodpek,  mspacpls, puckman_state, empty_init,  ROT90, "Scott Lawrence", "Miss Snoop v1.3 [f]", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2014, ottop1,   mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Scott Lawrence", "Otto Project P1", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2014, ottop2,   mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Scott Lawrence", "Otto Project P2", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2014, ottop3,   mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Scott Lawrence", "Otto Project P3", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2014, ottopz,   mspacman, woodpek,  mspacpls, puckman_state, empty_init,  ROT90, "Scott Lawrence", "Otto Project PZ", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2018, ottopza,  mspacman, woodpek,  mspacpls, puckman_state, empty_init,  ROT90, "hack", "Crazy Otto - The Original Ms Pacman (hack of ottopz)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2014, superp4g, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Scott Lawrence", "Otto Project P4G", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2014, superp4m, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Scott Lawrence", "Otto Project P4M", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2014, womanp5,  mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Scott Lawrence", "Otto Project P5", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
...
GAME( 2000, mrpacman, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Tim Appleton", "Mr. Pacman - Another Kind of Role Reversal", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, mspacfnt, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Tim Appleton", "Ms. Pacman with Pacman font", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, mspacwf,  mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Tim Appleton", "Ms Weird Fruit Pac", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, msrumble, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Tim Appleton", "Ms. Pac Rumble", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )

/* Sil's Hacks */

GAME( 2000, mselton,  mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Marcel Silvius", "Ms. Elton", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, msf1pac,  mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Marcel Silvius", "Ms. F1 Pacman", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, msindy,   mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Marcel Silvius", "Ms. Indy", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
...
GAME( 2000, msberzk,  mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Bobby Tribble", "Ms. Pacman Berzerk", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
...
GAME( 2000, chtmsatk, mspacman, woodpek,  mspacpls, puckman_state, empty_init,  ROT90, "[Midway]", "Ms. Pacman Plus [c]", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, chtmspa,  mspacman, woodpek,  mspacpls, puckman_state, empty_init,  ROT90, "[Midway]", "Ms. Pacman [c]", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2001, cookiem,  mspacman, woodpek,  mspacpls, puckman_state, empty_init,  ROT90, "Nic", "Cookie-Mon! [c]", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2008, cottoh,   mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Gatinho", "Crazy Otto simulation", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2010, cottoh2,  mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Gatinho", "Crazy Otto simulation Ver 2", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, fasthear, mspacman, woodpek,  mspacpls, puckman_state, empty_init,  ROT90, "PacHack", "Ms. Heart Burn [f]", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
...
GAME( 2000, msheartb, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "[Midway]", "Ms. Pacman Hearts (set 2)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, mshearts, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "[Midway]", "Ms. Pacman Hearts", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1981, mspac1,   mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "[Midway]", "Ms. Pacman (single rom set 2)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, mspacatb, mspacman, woodpek,  mspacpls, puckman_state, empty_init,  ROT90, "[Midway]", "Ms. Pacman Plus (Set B) [c]", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1980, mspacde,  mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "[Midway]", "Ms. Pacman -1", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1998, mspacii,  mspacman, mspacii,  mspacman, puckman_state, empty_init,  ROT90, "Orca", "Ms. Pacman II", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1983, mspacit,  mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "[Midway]", "Ms. Pacman -2", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1983, mspacit2, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "[Midway]", "Ms. Pacman -3", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1981, mspacj,   mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "[Midway]", "Ms. Pacman (Jamma? Bootleg)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1981, mspacmanl,mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90,  "hack", "Ms. Pacman (large roms)[f]", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2007, mspacmap, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90,  "Don Hodges", "Ms. Pacman (patched)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, mspacmbg, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "[Midway]", "Ms. Pacman (single rom)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2006, mspacpbl, mspacman, woodpek,  mspacpls, puckman_state, empty_init,  ROT90, "Dav/PMP", "Ms. Pac Plus (bootleg)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2017, mspacpbla,mspacman, woodpek,  mspacpls, puckman_state, empty_init,  ROT90, "Mameplus", "Ms. Pac Man (Super) Plus", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, mspacrip, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "R3mer", "Ms. Pac-Mortem", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2018, pacandroid, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Mameplus", "Pac Android", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, mspacsup, mspacman, woodpek,  mspacpls, puckman_state, empty_init,  ROT90, "[Midway]", "Super Ms. Pac-Man", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, mssilad,  mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "[Midway]", "Ms. Pacman After Dark (Sil)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, msultra,  mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "PacFan", "Ms. Ultra Pacman", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, msvectr,  mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "[Midway]", "Vector Ms. Pacman", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, msyakman, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Jeff Minter", "Ms. Yak Man", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1982, pacgalu,  mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Uchida", "Pac-Gal (Hearts)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2001, petshops,  mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "Weirdness Inc", "Pet Shop Freak-Out!", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE ) //The roms of the aristmk5 system have the same name.
GAME( 2002, piranha2, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "US Billiards", "Piranha 2 Revenge!", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, sueworld, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "PacFay", "Sue's World", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, sueworlb, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "PacFay", "Sue's World (Old)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 19??, supmspac, mspacman, woodpek,  mspacpls, puckman_state, empty_init,  ROT90, "Spedic Vending", "Super Ms Pac-man [f]", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, vectratk, mspacman, woodpek,  mspacpls, puckman_state, empty_init,  ROT90, "[Midway]", "Vector Attack [c]", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, zolaad,   mspacman, zolapac,  mspacman, puckman_state, empty_init,  ROT90, "Tqwn Amusement", "Super Zola Pac Gal After Dark", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, zolaatk,  mspacman, zolapac,  mspacman, puckman_state, empty_init,  ROT90, "Tqwn Amusement", "Super Zola Pac Gal Attack", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, zolamaze, mspacman, woodpek,  mspacman, puckman_state, empty_init,  ROT90, "[Midway]", "Ms. Pacman No Exit", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, zolapac,  mspacman, zolapac,  mspacman, puckman_state, empty_init,  ROT90, "Tqwn Amusement", "Super Zola Pac Gal", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, zolaslow, mspacman, zolapac,  mspacman, puckman_state, empty_init,  ROT90, "Tqwn Amusement", "Super Zola Pac Gal (Slow)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, zolatunl, mspacman, zolapac,  mspacman, puckman_state, empty_init,  ROT90, "Tqwn Amusement", "Super Zola Pac Gal (Tunnels)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, zolavect, mspacman, zolapac,  mspacman, puckman_state, empty_init,  ROT90, "Tqwn Amusement", "Vector Super Zola Pac Gal", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2017, mspacmans01, mspacman, zolapac,  mspacman, puckman_state, empty_init,  ROT90, "Mameplus", "Ms Pacman (hack s01)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2017, mspacmans02, mspacman, zolapac,  mspacman, puckman_state, empty_init,  ROT90, "Mameplus", "Ms Pacman (Fast)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2017, mspacmans03, mspacman, zolapac,  mspacman, puckman_state, empty_init,  ROT90, "Mameplus", "Ms Pacman (Brazil)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2017, mspacmans04, mspacman, zolapac,  mspacman, puckman_state, empty_init,  ROT90, "Mameplus", "Ms Pacman (Brazil Fast)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
...
GAME( 1981, otto1012, 0,        otto1012, mspacman, puckman_state, empty_init,    ROT90,  "General Computer", "Crazy Otto (prototype of 12 Oct 1981)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1981, otto1020, otto1012, otto1012, mspacman, puckman_state, empty_init,    ROT90,  "General Computer", "Crazy Otto (prototype of ~20 Oct 1981)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1981, otto1029, otto1012, otto1012, mspacman, puckman_state, init_otto1029, ROT90,  "General Computer", "Crazy Otto (prototype of 29 Oct 1981)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1981, sp4n1029, otto1012, otto1012, mspacman, puckman_state, init_otto1029, ROT90,  "General Computer", "Super Pac-Man (prototype of 29 Oct 1981 with Crazy Otto monsters)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1981, sp4o1029, otto1012, otto1012, mspacman, puckman_state, init_otto1029, ROT90,  "General Computer", "Super Pac-Man (prototype of 29 Oct 1981 with Pac-Man monsters)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
#endif
...
/* Update */
GAME( 1981, mspacmab2,    mspacman,woodpek,  mspacman, puckman_state,  empty_init,    ROT90,  "bootleg",            "Ms. Pac-Man (bootleg, set 2)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1991, mspacmanbcc,  mspacman,woodpek,  mspacman, puckman_state,  empty_init,    ROT90,  "bootleg (Tecnausa)", "Come-Cocos (Ms. Pac-Man) ('Made in Greece' Tecnausa bootleg)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1992, mspacmanbco,  mspacman,woodpek,  mspacman, puckman_state,  empty_init,    ROT90,  "bootleg (Cocamatic)","Come-Cocos (Ms. Pac-Man) (Cocamatic bootleg)", MACHINE_IMPERFECT_COLORS | MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 198?, mspacmanbg,   mspacman,woodpek,  mspacman, puckman_state,  empty_init,    ROT90,  "bootleg",            "Ms. Pac-Man ('Made in Greece' bootleg, set 1)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1997, mspacmanbg2,  mspacman,woodpek,  mspacman, puckman_state,  empty_init,    ROT90,  "bootleg",            "Ms. Pac-Man ('Made in Greece' bootleg, set 2)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1992, mspacmanbgd,  mspacman,woodpek,  mspacman, puckman_state,  empty_init,    ROT90,  "bootleg (Datamat)",  "Miss Pukman ('Made in Greece' Datamat bootleg)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1991, mspacmanbhe,  mspacman,woodpek,  mspacman, puckman_state,  empty_init,    ROT90,  "bootleg (Herle SA)", "Come-Cocos (Ms. Pac-Man) ('Made in Greece' Herle SA bootleg)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1992, mspacmanblt,  mspacman,woodpek,  mspacman, puckman_state,  empty_init,    ROT90,  "bootleg (Triunvi)",  "Come-Cocos (Ms. Pac-Man) ('Made in Greece' Triunvi bootleg)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1981, mspacmancr,   mspacman,mspacman, mspacman, puckman_state,  init_mspacman, ROT90,  "bootleg",        "Ms. Pac-Man (bootleg on Crush Roller Hardware)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1982, mspacmbmc,    mspacman,woodpek,  mspacman, puckman_state,  empty_init,    ROT90,  "bootleg (Marti Colls)", "Ms. Pac-Man (Marti Colls bootleg)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1981, pacgal2,      mspacman,mspacman, mspacman, puckman_state,  init_mspacman, ROT90,  "bootleg",        "Pac-Gal (set 2)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1981, mspacii3,     mspacman,woodpek,  mspacman, puckman_state,  empty_init,    ROT90,  "bootleg (Orca)",     "Ms. Pac-Man II (Orca bootleg set 1)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1981, mspacmab4,    mspacman,woodpek,  mspacman, puckman_state,  empty_init,    ROT90,  "bootleg",            "Ms. Pac-Man (bootleg, set 4)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1992, mspacmanblt2, mspacman,woodpek,  mspacman, puckman_state,  empty_init,    ROT90,  "bootleg (Triunvi)",  "Come-Cocos (Ms. Pac-Man) ('Made in Greece' Triunvi bootleg, set 2)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1982, mspacmanlai,  mspacman,woodpek,  mspacman, puckman_state,  empty_init,    ROT90,  "bootleg (Leisure and Allied)", "Ms. Pac-Man (Leisure and Allied bootleg)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1992, mspacmanbgc,  mspacman,woodpek,  mspacman, puckman_state,  empty_init,    ROT90,  "bootleg (Enavi)",    "Ms. Pac-Man ('Made in Greece' Enavi bootleg)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
