...
/* Bombjack Hack */
GAME( 1984, bombjackhc01,   bombjack, bombjack, bombjack, bombjack_state, empty_init, ROT90, "hack",    "Bomb Jack (Translation Greek)", MACHINE_SUPPORTS_SAVE )
GAME( 1984, bombjackhc02,   bombjack, bombjack, bombjack, bombjack_state, empty_init, ROT90, "hack",    "Bomb Jack (Translation Chinese)", MACHINE_SUPPORTS_SAVE )
