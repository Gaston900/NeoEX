...
/* Tempest Hack */
GAME( 2000, temped,    tempest, tempest, tempest, tempest_state, empty_init,  ROT270, "hack",   "TempEd", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, tempall,   tempest, tempest, tempest, tempest_state, empty_init,  ROT270, "hack",   "Tempest All Levels", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, temptwst,  tempest, tempest, tempest, tempest_state, empty_init,  ROT270, "Twisty", "Tempest Twisted", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, temptwsta, tempest, tempest, tempest, tempest_state, empty_init,  ROT270, "Twisty", "Tempest Twisted (Alt)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, temptwst2, tempest, tempest, tempest, tempest_state, empty_init,  ROT270, "Twisty", "Tempest Twisty's Revenge", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, temptwst3, tempest, tempest, tempest, tempest_state, empty_init,  ROT270, "Twisty", "Tempest Psycho Twist", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, temptwst4, tempest, tempest, tempest, tempest_state, empty_init,  ROT270, "Twisty", "Tempest Twisted Maniac", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2000, tempm,     tempest, tempest, tempest, tempest_state, empty_init,  ROT270, "hack",   "Tempest Mark's Hacks", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2001, tempmg,    tempest, tempmg,  tempest, tempmg_state,  init_tempmg, ROT270, "Clay Cowgill", "Tempest Multigame", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 1999, vbrakout,  tempest, tempest, tempest, tempest_state, empty_init,  ROT270, "Clay Cowgill", "Vector Breakout", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
