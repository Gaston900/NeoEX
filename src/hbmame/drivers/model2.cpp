...
/* Model2 Hack */
GAME( 2000?, srallyp,  srallyc, srallyc, srallyc, model2a_state, empty_init, ROT0, "Kyle Hodgetts", "Sega Rally Championship - Twin/DX (Pro Drivin)'", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
