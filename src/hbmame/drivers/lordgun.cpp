...
/* lordgun Hack */
GAME( 2018, alienchahc01,  aliencha,  aliencha, aliencha, lordgun_state, empty_init,   ROT0,    "hack",       "Alien Challenge (Easy Special Attacks)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
