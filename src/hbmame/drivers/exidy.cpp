...
/* Exidy HomeBrew */
GAME( 2008, targtest,  targ,    targ,     targ,    targ_state,     init_targ,     ROT0, "Timothy Shiels", "Targ Test Rom (HB)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2022, spectest,  spectar, spectar,  spectar, spectar_state,  init_spectar,  ROT0, "Timothy Shiels", "Spectar Test Rom (HB)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
GAME( 2013, teetertfp, teetert, teetert,  teetert, teetert_state,  empty_init,    ROT0, "DogP", "Teeter Torture (Free Play)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
