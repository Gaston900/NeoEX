...
/* Namcona1 Hack */
GAME(1992, knckheadhc01,   knckhead,  namcona2,  namcona1_joy,  namcona2_state, init_knckhead, ROT0,   "DDj",        "Knuckle Heads (Easy Special Attacks)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
