...
/* Vamphalf Hack */
GAME( 2001, aohhc01,     aoh,     aoh,     aoh,      vamphalf_state,      init_aoh,    ROT0,    "DDJ",        "Age Of Heroes - Silkroad 2 (Easy Special Attacks)", MACHINE_NO_COCKTAIL | MACHINE_SUPPORTS_SAVE )
