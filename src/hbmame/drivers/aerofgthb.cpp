...
/* Aerofgt Hack */
GAME( 2022, aerofgthc01,    aerofgt,        aerofgt,    aerofgt,   aerofgt_state, empty_init,      ROT270,   "hack",      "Aero Fighters (Infinite Power)", MACHINE_SUPPORTS_SAVE | MACHINE_NO_COCKTAIL )
GAME( 2017, karatblzhc01,   karatblz,       karatblz,   karatblz,  aerofgt_state, empty_init,      ROT0,     "GOTVG",     "Karate Blazers (1V4 2017-09-30)", MACHINE_SUPPORTS_SAVE | MACHINE_NO_COCKTAIL )
