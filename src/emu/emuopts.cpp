...
const options_entry emu_options::s_option_entries[] =
{
	...
	{ OPTION_HASHPATH ";hash_directory;hash",            "config/hash",       OPTION_STRING,     "path to software definition files" }, // 修改的 (加斯顿90)
	{ OPTION_SAMPLEPATH ";sp",                           "support/samples",   OPTION_STRING,     "path to audio sample sets" }, // 修改的 (加斯顿90)
	{ OPTION_ARTPATH,                                    "support/artwork",   OPTION_STRING,     "path to artwork files" }, // 修改的 (加斯顿90)
	{ OPTION_CTRLRPATH,                                  "support/ctrlr",     OPTION_STRING,     "path to controller definitions" }, // 修改的 (加斯顿90)
	{ OPTION_INIPATH,                                    ".;ini;ini/presets",     OPTION_STRING,     "path to ini files" },
	{ OPTION_FONTPATH,                                   ".",         OPTION_STRING,     "path to font files" },
	{ OPTION_CHEATPATH,                                  "support/cheat",     OPTION_STRING,     "path to cheat files" }, // 修改的 (加斯顿90)
	{ OPTION_CROSSHAIRPATH,                              "config/crosshair", OPTION_STRING,     "path to crosshair files" }, // 修改的 (加斯顿90)
	{ OPTION_PLUGINSPATH,                                "config/plugins",   OPTION_STRING,     "path to plugin files" }, // 修改的 (加斯顿90)
	{ OPTION_LANGUAGEPATH,                               "config/language",  OPTION_STRING,     "path to UI translation files" }, // 修改的 (加斯顿90)
	{ OPTION_SWPATH,                                     "support/software", OPTION_STRING,     "path to loose software" }, // 修改的 (加斯顿90)

	// output directory options
	{ nullptr,                                           nullptr,     OPTION_HEADER,     "CORE OUTPUT DIRECTORY OPTIONS" },
	{ OPTION_CFG_DIRECTORY,                              "config/cfg",       OPTION_STRING,     "directory to save configurations" }, // 修改的 (加斯顿90)
	{ OPTION_NVRAM_DIRECTORY,                            "config/nvram",     OPTION_STRING,     "directory to save NVRAM contents" }, // 修改的 (加斯顿90)
	{ OPTION_INPUT_DIRECTORY,                            "config/inp",       OPTION_STRING,     "directory to save input device logs" }, // 修改的 (加斯顿90)
	{ OPTION_STATE_DIRECTORY,                            "config/sta",       OPTION_STRING,     "directory to save states" }, // 修改的 (加斯顿90)
	{ OPTION_SNAPSHOT_DIRECTORY,                         "support/snap",     OPTION_STRING,     "directory to save/load screenshots" }, // 修改的 (加斯顿90)
	{ OPTION_DIFF_DIRECTORY,                             "config/diff",      OPTION_STRING,     "directory to save hard drive image difference files" }, // 修改的 (加斯顿90)
	{ OPTION_COMMENT_DIRECTORY,                          "config/comments",  OPTION_STRING,     "directory to save debugger comments" }, // 修改的 (加斯顿90)
	{ OPTION_VIDEO_DIRECTORY,                          	 "support/video",  	 OPTION_STRING,     "directory to save/load video files" }, // 修改的 (加斯顿90)
	{ OPTION_SHARE_DIRECTORY,                            "config/share",     OPTION_STRING,     "directory to share with emulated machines" }, // 修改的 (加斯顿90)
	...
	{ OPTION_KEEPASPECT ";ka",                           "0",         OPTION_BOOLEAN,    "maintain aspect ratio when scaling to fill output screen/window" }, // 修改的 (加斯顿90)
	...
	{ OPTION_CHEAT ";c",                                 "1",         OPTION_BOOLEAN,    "enable cheat subsystem" }, // 修改的 (加斯顿90)
	...
	{ OPTION_NVRAM_SAVE ";nvwrite",                      "0",         OPTION_BOOLEAN,    "save NVRAM data on exit" }, // 修改的 (加斯顿90)
